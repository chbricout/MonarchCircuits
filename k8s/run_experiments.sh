for kernel_size in 1 2 4 8 16 32; do
  for layer_type in "dense" "monarch"; do
    job_yaml=$(EXP_ARGS="-ms 20000,1 -hs 1024 -ds imagenet32 -ly $layer_type  -ps $kernel_size -sloc output/32_${kernel_size}x${kernel_size}_lossy_${layer_type}.jpc" envsubst <train-template.yaml)
